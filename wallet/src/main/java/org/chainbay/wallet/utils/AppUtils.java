package org.chainbay.wallet.utils;
...
public class AppUtils {
    ...
    public static Intent getAppOpenIntentByPackageName(Context context, String packageName, String activityName){
        //Activity完整名
        String mainAct = activityName;
        //根据包名寻找
